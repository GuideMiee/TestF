...
const Resume = () => {
  return (
    <div className="bg-white p-6 max-w-4xl mx-auto font-sans">
      ...
      <img src="public/images/IMG_8927.jpg" alt="Profile" className="w-24 h-24 object-cover rounded-full mb-4 sm:mb-0 sm:mr-6 border-4 border-white" />

        <div className="text-center sm:text-left">
          <h1 className="text-2xl font-bold text-gray-800">THAMMATORN SUDJAI</h1>
          <p className="text-blue-600 font-semibold">FRONT END, BACK END, FULL STACK</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <Section title="Certificate" icon={<Award className="text-blue-500" />}>
          ...
          <Section title="Experience" icon={<Briefcase className="text-blue-500" />}>
        ...
        <div>
          <Section title="Introduction" icon={<User className="text-blue-500" />}>
            <p className="text-gray-700 text-sm">I am a proactive and adaptable individual committed to continuous skill development and growth. My strong willingness to learn and my ability to quickly adjust to new environments enable me to contribute effectively to diverse teams and projects. I am eager to leverage my skills and experiences to drive success and achieve excellence in every opportunity.</p>
          </Section>
          ...
          <Section title="Program" icon={<Code className="text-blue-500" />}>
            <div className="grid grid-cols-4 gap-3">
              <img src="public/images/premierepro.png" alt="Premiere Pro" className="w-8 h-8" />
              <img src="public/images/photoshop.png" alt="Photoshop" className="w-8 h-8" />
              <img src="public/images/vscode.png" alt="Visual Studio Code" className="w-8 h-8" />
              <img src="public/images/vb.png" alt="Visual Studio" className="w-8 h-8" />
              <img src="public/images/github.png" alt="GitHub" className="w-8 h-8" />
              <img src="public/images/word.png" alt="Word" className="w-8 h-8" />
              <img src="public/images/powerpoint.png" alt="PowerPoint" className="w-8 h-8" />
              <img src="public/images/canva.png" alt="Canva" className="w-8 h-8" />
            </div>
          </Section>
